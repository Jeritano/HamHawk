...
CREATE TABLE IF NOT EXISTS bookmark (
  id TEXT PRIMARY KEY, label TEXT NOT NULL, kind TEXT NOT NULL, url TEXT NOT NULL,
  freq_hz INTEGER NOT NULL, mode TEXT NOT NULL, lane TEXT NOT NULL, created_at INTEGER NOT NULL
);

CREATE TABLE IF NOT EXISTS alert_rule (
  id TEXT PRIMARY KEY, name TEXT NOT NULL, pattern TEXT NOT NULL, enabled INTEGER NOT NULL DEFAULT 1
);

CREATE TABLE IF NOT EXISTS alert_hit (
  id INTEGER PRIMARY KEY AUTOINCREMENT, rule_id TEXT NOT NULL, rule_name TEXT NOT NULL,
  receiver_id TEXT NOT NULL, ts_ms INTEGER NOT NULL, text TEXT NOT NULL
);
CREATE INDEX IF NOT EXISTS idx_alert_hit_ts ON alert_hit(ts_ms);
